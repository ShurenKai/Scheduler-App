...
/////////////////////////////////////
// Tests for retrieving interviews //
/////////////////////////////////////
...
test("getInterviewersForDay returns an array of interviewers for a particular day", () => {
  const result = getInterviewersForDay(state, "Monday");
...
//   expect(second).toEqual(state.interviewers[0]);
// });
